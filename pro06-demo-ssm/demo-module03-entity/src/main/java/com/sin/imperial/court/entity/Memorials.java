...
public class Memorials {
    ...
    public Memorials(String memorialsTitle, Integer memorialsId, String memorialsContent, Integer memorialsEmp, String memorialsCreateTime, String feedbackTime, String feedbackContent, Integer memorialsStatus) {
